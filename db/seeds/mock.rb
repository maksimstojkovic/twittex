puts "Importing mock data into database"
...
# Samples follows received by user1
...
# Sample follows sent by user1
f3 = Follow.find_or_create_by(followee: u2, follower: u1, accepted: false)
f4 = Follow.find_or_create_by(followee: u3, follower: u1, accepted: true)

puts "Done importing mock data"
