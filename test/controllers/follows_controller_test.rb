...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference("Follow.count") do
      post follows_url, params: { follow: { accepted: @follow.accepted, followee_id: @follow.followee_id, follower_id: @follow.follower_id } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { accepted: @follow.accepted, followee_id: @follow.followee_id, follower_id: @follow.follower_id } }
